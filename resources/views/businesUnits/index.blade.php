                            ...
                            <div class="card-body">
                                ...
                                <div class="card-text">
                                    <p><small class="text-muted">Unidad de negocio creada
                                            ...
                                            <form action="{{route('bussinesUnit.supr',$unit)}}" method="Post" class="d-inline" id="eliminar">
                                                @csrf
                                                 @method('PATCH')
                                    ...
                                    <button type="button" data-bs-toggle="modal"
                                    data-bs-target="#editModal{{ $unit->id }}"
                                    class="float-right btn btn-outline-primary btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
                                    ...
                                    <div class="modal fade" id="editModal{{ $unit->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form action="{{ route('bussinesUnit.update', $unit) }}" method="POST" enctype="multipart/form-data">
                                                    @csrf @method('PATCH')
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <label for="">Subir Nueva imagen (Campo opcional)</label>
